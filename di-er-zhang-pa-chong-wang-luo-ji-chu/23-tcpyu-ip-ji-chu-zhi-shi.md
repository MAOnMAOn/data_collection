...
![](/assets/ifconfigaa.png)

可以看到 IP 地址为 192.168.1.52
...
我们可以使用命令 nslookup 或者 ping 来查看与域名相对应的 IP 地址，由于实验楼网络限制，我们可以使用ping github.com查看。运行：

`ping www.github.com`

![](/assets/pinggithub.png)

关于域名与 IP 地址的映射关系，以及 IP 地址的路由和发现机制，将在后续内容之中进行详细的说明。
